  ...
  return (
    <DashboardLayout>
      <div className="space-y-6">
        <div>
          <h1 className="text-3xl font-bold">Cadastro de Master Trader</h1>
        ...
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Forneça informações sobre sua estratégia e conecte sua conta da Bybit.
            </CardDescription>
          </CardHeader>
          <CardContent>
            <Form {...form}>
...
export default MasterTraderSignup;
